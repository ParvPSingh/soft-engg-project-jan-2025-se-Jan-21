<!-- filepath: d:\Desktop\soft-engg-project-jan-2025-se-Jan-21-main\soft-engg-project-jan-2025-se-Jan-21-main\frontend\src\components\ChatBot_TA.vue -->
<template>
    <div>
      <!-- Chat Bubble Icon -->
          ...
          <div class="chatbot-messages" ref="messagesContainer">
            ...
            <div class="bot-message-container">
              ...
              <div class="bot-message">
                <p>Welcome to the Instructor Assistant! I can help you with grading policies, student inquiries, academic integrity, deadlines, and more.</p>
