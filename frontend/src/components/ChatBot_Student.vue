...
<template>
    <div>
      <!-- Chat Bubble Icon -->
      <div class="chatbot-icon" @click="toggleChat" :class="{ 'bounce': animateBubble }">
        ...
        <div v-if="isChatOpen" class="chatbot-container">
          ...
          <div class="chatbot-header">
            ...
            <div class="header-actions">
              ...
              <button @click="toggleChat" class="action-button" title="Close chat">
          ...
          <div class="chatbot-messages" ref="messagesContainer">
            ...
            <div class="bot-message-container">
              ...
              <div class="bot-message">
                <p>Welcome to Autobot! I can help you understand course concepts and find information in your course materials. Feel free to ask me questions about your Data Science program.</p>
  ...
  export default {
    ...
    methods: {
      ...
      async getBotResponse(message) {
        try {
          const response = await fetch('http://127.0.0.1:5000/api/chatbot/student', {
            method: 'POST',
            headers: {
  ...
  * {
  ...
  .chatbot-icon {
    ...
    height: 60px;
    cursor: pointer;
    background: linear-gradient(135deg, #2193b0, #6dd5ed); /* Different color scheme */
    border-radius: 50%;
    display: flex;
